...
const criarListaButton = document.getElementById('btn-criar-lista');
const adcFilmeListaBtn = document.getElementById('btn-adc-filme');
...
criarListaButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const descInput = document.getElementById('desc-lista');
    yield criarLista(nomeInput.value, descInput.value);
}));
adcFilmeListaBtn.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    const listaIdInput = document.getElementById('idListaInput');
    const filmeIdInput = document.getElementById('idListaFilme');
    yield adicionarFilmeNaLista(Number(filmeIdInput.value), Number(listaIdInput.value));
}));
